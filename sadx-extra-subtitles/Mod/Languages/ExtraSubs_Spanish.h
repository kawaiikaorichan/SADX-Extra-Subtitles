...
const char* SkyChase1_Spanish[] = { "\a¡Nora de mostrar un poco de mi poder!", "\a¡Egg Cannon listo!", "\a¡FUEGO!", "\a¡Ah, nos dieron!", "\a¡Sí! ¡Ah...!" };
const char* SkyChase2_Spanish[] = { "\a¡A transformarse!", "\a¡Guau...!", "\a¡Hagámoslo!", NULL };
const char* WelcomeToTwinklePark_Spanish[] = { "\a¡Bienvenidos a Twinkle Park!", NULL };

std::map<int, SubtitleData> ExtraSubs_Spanish
{
	/* Menu voices */
...
std::map<int, SubtitleData> ExtraSubs_SE_Spanish
{
	// Sonic
